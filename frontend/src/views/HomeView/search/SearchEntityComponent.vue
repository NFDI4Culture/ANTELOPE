    ...
    defineExpose({
        ...
        getParams(): IEntitySearchData {
            return validate({
                ...
                mock: {"json":{"el_result":{"ents":[{"start":8,"end":16,"label":"van gogh","text":"van gogh","idx":1}],"doc":"Vincent van Gogh was a dutch post-impressionist painter","ids":{"1":"van gogh","2":"van gogh"}}},"html":"<div class=\"entities\" style=\"line-height: 2.5; direction: ltr\">Vincent \n<mark class=\"entity\" style=\"background: #ddd; padding: 0.45em 0.6em; margin: 0 0.25em; line-height: 1; border-radius: 0.35em;\">\n    van Gogh\n    <span style=\"font-size: 0.8em; font-weight: bold; line-height: 1; border-radius: 0.35em; vertical-align: middle; margin-left: 0.5rem\">van gogh<\/span>\n<\/mark>\n was a dutch post-impressionist painter<\/div>"}
            });
        }
    });
</script>
...
<template>
    <TextareaComponent placeholder="e.g. Vincent van Gogh was a dutch post-impressionist painter" ref="tSearchtext">
        ...
        <template #info>
            Use Entity recognition to map as many words as possible, of your input text, to entities from the datasources. If you want to search for a single term, that is described by your text, choose 'Terminology search' above.
        </template>
    </TextareaComponent>
    <h4>
        Dictionaries
    ...
    <CheckboxComponent ref="cSettings_ClassDuplicates">
        ...
        <InfoComponent>
            If set, the result hierarchy graph may contain the same class multiple times (in different branches). This will give you a more complete view of the original results but may show the same information multiple times. Every class will still be shown only once per branch in the hierarchy tree to avoid circles (circles are possible in graphs but not in trees like taxonomies).
        </InfoComponent>
    </CheckboxComponent>
