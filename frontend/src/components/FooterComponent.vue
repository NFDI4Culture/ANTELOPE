    ...
    <footer class="footer wrapper">
        <nav>
            <ol>
                ...
                <li><a href="https://nfdi4culture.de/services/details/annotation-terminology-lookup-and-personalization-antelope.html" target="_blank">NFDI4Culture</a></li>
                <li><a href="https://www.tib.eu/en/imprint" target="_blank">Contact</a></li>
            </ol>
        </nav>
        <a class="footer-org" href="https://www.tib.eu/en/research-development/research-groups-and-labs/open-science/research-development" target="_blank">
